#
# File:    estimateALAAMSA_mod.py
# Author:  Alex Stivala
# Modified by: Thilara Ekanayake
# Created: May 2020
# Modified: Oct 2024
#
...
def run_on_network_attr(edgelist_filename, param_func_list, labels,
    ...
    if converged:
        ...
        output["std_error"] = std_error
        output["t_ratio"] = t_ratio
        output["significant"] = significant
        ...
        gofresult = gof(G, A, gof_param_func_list, gof_theta,
                        ...
                        outputStatsFilename = "outputGoFstatsFile.txt",
        ...
        output["gof_n"] = n
        output["goflabels"] = goflabels
        output["gofresults"] = gofresult[0]
        output["mahalanobis_distance"] = gofresult[1]
...
#     """
#     run_on_network_attr(
#         '../data/University students 643/edgelist_u643_VPNet.txt',
...
#         '../data/University students 643/Outcome_dropout643.txt',
#         '../data/University students 643/BIN_sex.txt',
#         '../data/University students 643/CONT_fails.txt'
#     )
